...
//Class: Double Shot Enemy, controls the way double shot enemys shooting behaves.
...
public class DoubleShotEnemy : MonoBehaviour
{
    ...
    ///bulletPathNormal is used to store the 90degree tangent to the bulletPath direction, it is used to space the two bullets apart:

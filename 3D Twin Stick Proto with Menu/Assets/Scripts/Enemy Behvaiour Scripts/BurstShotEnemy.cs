...
//Class: Burst Shot Enemy, controls the way burst shot enemys shooting behaves.
///Adapted from the EnemyShootingTracking script.
///Author: Lewis Nicoll
public class BurstShotEnemy : MonoBehaviour
{
    ...
    //Private Variables:
        ...
        ///Variables used in making the "burst" adaptation to the tank:
        ///These variables are required to differentiate the time between shots within a burst and the time between bursts
